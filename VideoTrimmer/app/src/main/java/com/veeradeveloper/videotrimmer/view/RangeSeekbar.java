...
public class RangeSeekbar extends View {
    ...
    private static final int DEFAULT_FILLED_COLOR = Color.parseColor("#ffc44f");

    private static final int DEFAULT_EMPTY_COLOR = Color.parseColor("#ffc44f");
    ...
    private static final int DEFAULT_RANGE_COUNT = 9;
        ...
        if (attrs != null) {
            ...
            try {
                ...
                emptyColor = a.getColor(
                        R.styleable.RangeSliderView_emptyColor, DEFAULT_FILLED_COLOR);
